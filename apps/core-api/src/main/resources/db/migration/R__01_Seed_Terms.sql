...
제1조 (목적)
본 약관은 포트랠리(이하 "회사"라 합니다)가 제공하는 포트폴리오 관리 서비스(이하 "서비스"라 합니다)의 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
...
포트랠리(이하 "회사"라 합니다)는 이용자의 개인정보를 중요시하며, 개인정보 보호법을 준수하고 있습니다.
...
포트랠리(이하 "회사"라 합니다)는 다음과 같이 마케팅 정보를 제공합니다.
